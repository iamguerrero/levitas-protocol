...
async function main() {
  console.log("=== DEPLOYING V4 SIMPLIFIED BOOTSTRAP VERSION ===");
  ...
  if (finalOwner === mintRedeemAddress) {
    console.log("🎉 SUCCESS! V4 contracts deployed");
    ...
    try {
      ...
      console.log("✅ V4 FIRST MINT WORKS!");
      ...
      console.log("❌ V4 first mint failed:", error.message);
    }
