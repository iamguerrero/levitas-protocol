...
export interface EVIXMintRedeemV5SimpleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "evix"
      | "getCollateralRatio"
...
export interface EVIXMintRedeemV5Simple extends BaseContract {
  connect(runner?: ContractRunner | null): EVIXMintRedeemV5Simple;
  waitForDeployment(): Promise<this>;

  interface: EVIXMintRedeemV5SimpleInterface;
