...
export interface MintRedeemV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCollateral"
      | "bvix"
...
export interface MintRedeemV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MintRedeemV2;
  waitForDeployment(): Promise<this>;

  interface: MintRedeemV2Interface;
