...
export interface EVIXMintRedeemV6Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "evix"
      | "getCollateralRatio"
...
export interface EVIXMintRedeemV6 extends BaseContract {
  connect(runner?: ContractRunner | null): EVIXMintRedeemV6;
  waitForDeployment(): Promise<this>;

  interface: EVIXMintRedeemV6Interface;
