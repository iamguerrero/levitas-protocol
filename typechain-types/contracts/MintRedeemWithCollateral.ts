...
export interface MintRedeemWithCollateralInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCollateral"
      | "bvix"
...
export interface MintRedeemWithCollateral extends BaseContract {
  connect(runner?: ContractRunner | null): MintRedeemWithCollateral;
  waitForDeployment(): Promise<this>;

  interface: MintRedeemWithCollateralInterface;
