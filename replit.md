...
⚠️ **POLYGON AMOY NETWORK ISSUES (July 24, 2025)** - Widespread "missing trie node" RPC errors affecting Polygon Amoy testnet causing mint/redeem transactions to fail in MetaMask, this is a network-wide issue not specific to our application
