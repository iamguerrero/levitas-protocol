...
/**
 * @title MintRedeem V6 - Position-Aware Surplus-Refunding Vault
 * @notice Based on V5 with per-user position tracking for surplus refunding
 */
contract MintRedeemV6 is Ownable {
    IERC20 public usdc;
