...
async function main() {
  console.log("🧪 Testing new EVIX deployment...");
  
  const [deployer] = await ethers.getSigners();
  console.log("Testing with account:", deployer.address);
  
  // Latest contract addresses
  const EVIX_ADDRESS = '0x4d0ddFBCBa76f2e72B0Fef2fdDcaE9ddd6922397';
  const EVIX_MINT_REDEEM_ADDRESS = '0x93cd26a110dB3fDdA32d8a6a1a5a05CEf20A4A6d';
